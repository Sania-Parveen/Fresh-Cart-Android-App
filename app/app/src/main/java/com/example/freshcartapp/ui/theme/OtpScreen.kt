...
fun OtpScreen(
    ...
    val ticks by freshViewModel.ticks.collectAsState()
    val phoneNumber by freshViewModel.phoneNumber.collectAsState()

    OtpTextBox(otp = otp, freshViewModel = freshViewModel)
